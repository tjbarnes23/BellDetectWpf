...
namespace BellDetectWpf.Enums
{
    ...
    public static class FilterFIRExt
    {
        ...
        {
            {FilterFIREnum.pm_B9_1, "PM B9; 1048-1098-1335-1385 Hz; 592 order; 44.1 kHz; -30/-5 dB"},
            {FilterFIREnum.pm_C15_1, "PM C15; 396.75-514-534-651.25 Hz; 275 order; 48 kHz; -30/-5 dB"},
            {FilterFIREnum.pm_C15_2, "PM C15; 512-520-524-532 Hz; 8072 order; 48 kHz; -50/-3 dB"}
        };
    }
